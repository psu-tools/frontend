...
<template>
  ...
  >
    <div class="flex flex-col justify-between flex-1 lg:max-w-[600px] h-full mb-10 lg:mb-0">
      <div>
      ...
      <div class="mt-auto text-3xl hidden md:block text-(--color-glay-about)">PSU Tools</div>
    </div>
