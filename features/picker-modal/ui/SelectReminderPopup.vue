...
const handleSelectedTime = (time: number) => tripFormStore.setReminderTime(time)
</script>
  ...
  <Teleport to="#modal-container">
    <div class="absolute inset-0 z-50 bg-black/40 flex items-end px-5 pb-11" @click.self="emit('close')">
      <div class="w-full max-w-md mx-auto bg-white rounded-2xl px-[30px] py-5 shadow-xl">
        ...
        <ReminderTimePicker :initial-reminder-time="tripFormStore.reminderTime" @select="handleSelectedTime" />
        <button
